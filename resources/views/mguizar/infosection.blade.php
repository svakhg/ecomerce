    ...
    <div class="col-md-12" id="info-section">
        <div class="col-md-3">
            ...
            <div class="row justify-content-sm-center" style="text-align:-webkit-center;text-align: -moz-center;" >
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="text-align: -moz-center;text-align:-webkit-center;">
                    <img class="img-responsive footer-icons" src="img/americanexpress.png" alt="">

                </div>
                <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4" style="text-align: -moz-center;text-align:-webkit-center;">
                    <img class="img-responsive footer-icons" src="img/mastercard.png" alt="" style="margin-top:4px;">
                </div>
